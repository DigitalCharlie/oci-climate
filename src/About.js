...
export default function About(props) {
  ...
  return (
    <div  style={{ marginTop: props.headerHeight }}  className='About'>
      ...
      <p>
        This scope means that to get a more holistic picture of support for fossil fuels from any one G20 government, these international public finance figures should be combined with data on direct domestic fossil fuel subsidies, domestic public finance, support to energy-related state-owned enterprises, and countries – see for example <Link href="https://www.iisd.org/publications/g20-scorecard">this report</Link> OCI wrote with International Institute for Sustainable Development and Overseas Development Institute in 2020, or a <Link href="https://about.bnef.com/blog/g-20-fossil-fuel-support-hits-nearly-600-billion-in-2020/">2021 update</Link> using this methodology and our data from BloombergNEF in 2021.
      ...
      <p>
        You can download the data as a spreadsheet here. Definitions for each field are provided in the first tab, and a source for each transaction is in the last column. You can also read more background and analysis on public finance here.

      </p>
      <p><strong>How to cite this website</strong></p>
      <p>The data in the Public Finance for Energy Database is available for use under a <Link href="https://creativecommons.org/licenses/by-nc/4.0/">Creative Commons Attribution-NonCommercial 4.0 International License</Link>. If using this finance data, please cite it as Oil Change International, “Public Finance for Energy Database,” [Date Accessed], URL.</p>

      <h2>FAQ about international public finance</h2>
      <p><strong>Is international public finance a “subsidy”?</strong></p>
      <p>The World Trade Organization’s <Link href="https://www.wto.org/english/docs_e/legal_e/24-scm_01_e.htm">definition</Link> calls public finance a subsidy to energy production to the extent that it constitutes a “direct transfer of funds” (as with grants, loans, and equity infusion) or “potential direct transfers of funds or liabilities” (as with guarantees and insurance) to an energy project or sector. However, due to the lack of transparency and robust reporting from public finance institutions, it is not possible to separate out what portion of public finance is a subsidy component.</p>
      <p>
