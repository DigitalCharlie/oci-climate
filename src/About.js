...
export default function About(props) {
  ...
  return (
    <div  style={{ marginTop: props.headerHeight }}  className='About'>
      ...
      <h3 id={slugs[0]}><strong>Where does the data come from?</strong></h3>
      <p>
      ...
      <h3 id={slugs[5]}><strong>How to cite this website</strong></h3>
      ...
      <h3 id={slugs[6]}><strong>Is international public finance a “subsidy”?</strong></h3>
      ...
      <h3 id={slugs[7]}><strong>What do public finance institutions need to do to support a just energy transition aligned with 1.5C?</strong></h3>
