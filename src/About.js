...
<p>Oil Change International builds this dataset by tracking energy finance from public finance institutions at the transaction level. As of 2021, it covers over 15,000 transactions totalling $2 trillion+ back to 2008 for multilateral development banks and back to 2013 for the bilateral categories of public finance institutions. This data is sourced primarily from government and institution reporting (including annual reports with project information, press releases, freedom-of information requests, and project databases) as well as the Infrastructure Journal (IJ) Global database, Boston University’s Global Economic Governance Initiative’s <ExLink to="https://www.bu.edu/cgef/#/all/Country">China Global Energy Finance Database</ExLink>, and investigations by our partners at <ExLink to="https://forourclimate.org/en/">Solutions for our Climate</ExLink> (Korea), <ExLink to="https://www.jubileeaustralia.org/">Jubilee Australia</ExLink>, and <ExLink to="https://www.urgewald.org/en/english">Urgewald</ExLink> (Germany).</p>
