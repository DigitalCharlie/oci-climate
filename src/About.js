...
<p><strong>Other:</strong> Includes projects where (a) the energy source(s) are unclear or unidentified as well as (b) non-fossil energy sources that typically have significant impacts on the environment and human populations. This means we include large hydropower (over 30MW), biofuels, biomass, nuclear power, and incineration. If a project includes multiple energy sources, we split it into multiple transactions, but if this is not possible we also classify it as ‘Other.’ More than 70% of the finance in ‘Other’ is for transmission and distribution projects and other projects where the associated energy sources are unclear.</p>

<br /><h3 id={dataSlugs[1]}><strong>Where does the data come from?</strong></h3>
<p>Oil Change International builds this dataset by tracking energy finance from public finance institutions at the transaction level. As of 2021, it covers over 15,000 transactions totalling $2 trillion+ back to 2008 for multilateral development banks and back to 2013 for the bilateral categories of public finance institutions. This data is sourced primarily from government and institution reporting (including annual reports with project information, press releases, freedom-of information requests, and project databases) as well as the Infrastructure Journal (IJ) Global database, Boston University’s Global Economic Governance Initiative’s <ExLink href="https://www.bu.edu/cgef/#/all/Country">China Global Energy Finance Database</ExLink>, and investigations by our partners at <ExLink href="https://forourclimate.org/en/">Solutions for our Climate</ExLink> (Korea), <ExLink href="https://www.jubileeaustralia.org/">Jubilee Australia</ExLink>, and <ExLink href="https://www.urgewald.org/en/english">Urgewald</ExLink> (Germany).</p>
