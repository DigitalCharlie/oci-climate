    ...
    <div style={{ marginTop: props.headerHeight }} className={classNames('FinanceTracker', { singleColumnView })}>
      <div>
        <div className='description'>
          ...
          <p>
            “Single” exclusions are those covering only one part of the supply chain (or one type of indirect finance) at one or more of a country’s or MDB’s relevant institutions, while green “full” exclusions cover all supply chain stages across all institutions though with substantial loopholes in some cases. For a more detailed discussion of these policies, <ExLink href="http://priceofoil.org/g20-at-a-crossroads">see our latest report</ExLink>. “Average Annual Fossil Fuel Finance” figures are 2019-2021 averages for all G20 countries and MDBs. Non-G20 countries totals are 2018-2020 averages, from <ExLink href="https://www.iisd.org/publications/report/turning-glasgow-statement-into-action">research</ExLink> with International Institute for Sustainable Development.
          </p>
          <p>
